...
window.BUNDLE_DETAILS = {
  curated: {
    ...
    'daniels-skincare': {
      ...
      whyThis: "The skincare half of the Ultimate, without the supplements. The 7 AM steps (Wash, Balance, Boost, Hyaluronic, Defense, Soft, Shield) prep, protect, and shield the skin every morning — botanical cleanser, 3.5% glycolic exfoliator, bio-peptide growth factor serum, pure HA, CE Ferulic antioxidant architecture, advanced HA moisturizer, and broad-spectrum mineral SPF. The 6 PM steps (Bounce, Renewal, Firm, Hydration, Eye, Glow) work at night when active ingredients aren't fighting UV — five-active retinol, multi-action peeling pads, advanced peptide complex, hyaluronic mist, DCX peptide eye serum, and squalane + HA spheres. Clear handles daily clarification (BHA at 2%), Mask and Polish are the weekly reset that compounds everything else. Together it's the full topical protocol, layered for compounding effect.",
      timeline: [
      ...
      faq: [
        ...
        { q: 'What order do I apply them in?', a: 'AM: Wash → Balance (glycolic) → Boost (peptide growth factor) → Hyaluronic → Defense (CE Ferulic) → Soft → Shield (mineral SPF). PM: Wash → Renewal (multi-acid pads) OR Bounce (5-active retinol) — alternate nights → Firm → Hydration (HA mist) → Eye → Glow (HA-in-squalane seal). Clear is spot-applied at any point; Mask + Polish are weekly add-ons.' },
    ...
    'am': {
      ...
      faq: [
        { q: 'What order do I use these in?', a: 'In order: Wash, Balance (3.5% glycolic), Boost (peptide growth factor), Hyaluronic (serum), Defense (CE Ferulic antioxidant), Soft (moisturizer), Shield (mineral SPF). Apply each before the next is fully absorbed — thinnest to thickest, SPF always last.' },
  ...
  concern: {
    ...
    'starter': {
      ...
      faq: [
        ...
        { q: "Is this safe during pregnancy?", a: "Wash and Soft are pregnancy-safe. Balance contains glycolic acid at 3.5% daily-use concentration — most providers consider it acceptable during pregnancy, but some advise against any AHAs. For the strictest pregnancy-safe starter routine, swap Balance for The House Hyaluronic and you have a fully pregnancy-friendly daily foundation. Always confirm with your provider for your specific case." }
      ]
    },
    'reset': {
    ...
    'energy': {
      ...
      description: 'Five products — multivitamin, CoQ10, and vitamin D3 for foundational cellular energy, Burn for the metabolic and pre-task lift, and the Focus nootropic for the cognitive side of energy.',
      ...
      timeline: [
        { week: 'Week 1', text: 'Burn and Focus deliver same-day acute energy and mental clarity.' },
