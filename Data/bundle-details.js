...
window.BUNDLE_DETAILS = {
  curated: {
    ...
    'pm': {
      ...
      whyThis: "Nighttime is when actives go to work without UV interference. Bounce delivers a five-active retinol serum (retinol + stable vitamin C + HA + Matrixyl peptides + botanical skin-tightening trio) — the most-validated anti-aging architecture in dermatology, layered for tolerance. Renewal uses multi-action peeling pads (glycolic + lactic + salicylic) alternated with Bounce to resurface and brighten. Firm delivers an advanced peptide complex layered with hyaluronic acid and seaweed extract for collagen signaling from multiple angles. Mist delivers a hyaluronic mist to seal the actives without weight. Awake uses a triple-peptide complex with the DCX complex (targeting under-eye pigmentation) for the thin orbital skin. Glow's squalane + hyaluronic spheres seal it all in — the overnight finish that locks in everything below it. The combination produces visible firming, smoothing, and brightening over 8-12 weeks.",
      timeline: [
  ...
  concern: {
    ...
    'energy': {
      eyebrow: 'Daily Energy · Cellular Foundation + Cognitive Lift',
      description: 'Five products — multivitamin, CoQ10, and vitamin D3 for foundational cellular energy, Surge for the metabolic and pre-task lift, and the Focus nootropic for the cognitive side of energy.',
      whyThis: "Sustainable energy isn't one thing — it's foundational nutrients, mitochondrial function, metabolic flexibility, and cognitive engagement all working together. This bundle covers all four. Multi delivers the B-complex, iron, and zinc cells need for ATP production. Vitality (CoQ10) supports mitochondrial energy — the actual factories. Sunshine (vitamin D3) addresses one of the most common modern deficiencies, with documented mood and energy effects. Surge adds caffeine-and-amino-acid metabolic support for the days that need a clean lift without jitter. Focus (Alpha GPC + L-Tyrosine + Bacopa) handles the cognitive side — the mental energy that makes physical energy feel useful. Inside-out, all-day energy.",
      timeline: [
        { week: 'Week 1', text: 'Surge and Focus deliver same-day acute energy and mental clarity.' },
        { week: 'Week 4', text: 'Foundation nutrients fill in. Daily energy stabilizes; afternoon crashes less pronounced.' },
      ...
      faq: [
        { q: 'When should I take each supplement?', a: 'Morning with breakfast: Multi, Vitality, Sunshine (fat-soluble vitamins absorb best with food). Pre-task: Surge and Focus, 30 minutes before deep work or training. Boost (topical) goes on cleansed AM skin, before moisturizer.' },
        ...
        { q: 'When will I notice changes?', a: 'Same-day from Surge and Focus and the topical vitamin C. Daily energy stabilization at 4-6 weeks as nutrient stores fill in. Full CoQ10 + Bacopa effects at 8-12 weeks.' }
      ]
    },
    'focus': {
