...
window.BUNDLE_DETAILS = {
  curated: {
    ...
    'arianas': {
      ...
      whyThis: "Ariana's routine is the streamlined version: nine products that cover the essentials without overcomplicating. Wash, Boost, Defense, Renewal, Eye, Soft = a complete cleansing-to-overnight skincare arc using the most-validated actives (three-form vitamin C, CE Ferulic antioxidant defense, triple-acid resurfacing, bakuchiol + triple-peptide eye treatment). Multi, Radiance, Collagen = the daily nutrient foundation plus beauty support. It's intentionally smaller than the Ultimate — for users who want the high-confidence routine without 23 bottles to track.",
      timeline: [
  ...
  concern: {
    ...
    'glow': {
      ...
      description: 'Six glow-focused products — topical three-form vitamin C, the CE Ferulic antioxidant shield, the squalane-and-ceramide overnight lipid seal, the weekly zinc & sulfur clay mask, plus daily beauty vitamins and 10g of collagen. The full inside-out beauty stack.',
      whyThis: "Visible glow comes from combining topical and internal strategies. Topically: Boost (three-form vitamin C) brightens pigment irregularities; Defense (the CE Ferulic architecture — L-ascorbic acid + ferulic acid + niacinamide + B5 + vitamin E) protects from environmental dullness; Glow (squalane + ceramide-family lipid seal) locks in everything underneath with a luminous finish; Mask (bentonite + sulfur + salicylic + zinc, weekly) decongests skin every 7 days so light reflects more evenly. Internally: Radiance delivers the daily vitamin A/C/E/biotin foundation skin/hair/nails are literally built from; Collagen provides 10g daily peptides for skin elasticity and the water-binding capacity that produces a 'lit from within' look. Topical alone hits a ceiling — adding internal nutrient support pushes through it.",
      timeline: [
    ...
    'starter': {
      ...
      whyThis: "Most people's first skincare routine fails for the same reason: too many products, too many actives, too soon. The Skin Starter Bundle is the opposite. Wash is a barrier-respecting cleanser — rose hip seed oil, geranium, and Irish moss in a silky, fragrance-free base. Balance is daily tri-acid peeling pads (salicylic + lactic + mandelic) — gentle daily exfoliation that primes the surface without aggression. Soft is the daily All-in-One moisturizer with hyaluronic acid, avocado oil, copper ferment, and gentle vitamin A. No retinol serums, no treatment-strength acids, no L-ascorbic vitamin C — those come later, once the foundation is in place. Run this for 6-8 weeks before adding anything else. You'll know it's working when your skin no longer feels tight after cleansing and your makeup or SPF sits flat all day.",
      timeline: [
      ...
      faq: [
        ...
        { q: "Is this safe during pregnancy?", a: "Wash and Soft are pregnancy-safe (note: Soft contains low-dose retinyl palmitate — most providers consider it fine, but confirm with yours). Balance contains salicylic acid at gentle daily-use levels — most providers consider it acceptable but some advise against any salicylic acid during pregnancy. For the strictest pregnancy-safe starter routine, swap Balance for The House Hyaluronic and you have a fully pregnancy-friendly daily foundation. Always confirm with your provider for your specific case." }
      ]
    },
    'reset': {
    ...
    'stress': {
      ...
      description: 'Five products — KSM-66 ashwagandha, magnesium glycinate, and the adaptogenic greens that quiet the cortisol response, plus the daily peeling pads and the weekly detox mask. Skincare reframed as the calming self-care ritual it should be.',
      whyThis: "Chronic stress shows up on skin first — increased sebum, slower wound healing, barrier dysfunction, more visible reactivity — and at the nervous system long before the rest of the body says anything. This bundle works both fronts at once. Tranquil's KSM-66 ashwagandha is the most-studied adaptogen for cortisol reduction. Calm (magnesium glycinate) addresses the nervous-system magnesium depletion that's near-universal in chronically stressed adults. Greens layers in additional adaptogens (ginseng) on a nutrient-dense base for daily resilience. The topical half is built as a ritual rather than a treatment: Balance is the daily tri-acid peeling pad — a small sensory pause between cleanse and serums that doubles as a deliberate ten-second calm-down moment with visible exfoliation work happening underneath. Mask is the weekly detox treatment with bentonite, sulfur, and zinc — a slow, intentional ten-minute reset that pulls double duty as skincare and as decompression. Together, the pads and the mask reframe skincare as the calming self-care it should be, while the supplements work quietly on the cortisol response underneath.",
      timeline: [
    ...
    'gut': {
      ...
      whyThis: "Gut health affects nearly every other body system — and the gut-skin axis is one of the strongest connections. This bundle addresses the gut at three levels and supports the skin that bears the visible cost of gut issues. Biome provides 40 billion CFU of clinically-studied probiotic strains with MAKTREK Bi-Pass for stomach-acid survival. Seal (L-glutamine) directly supports the enterocytes lining the gut. Greens provides 22 plant-based ingredients including fiber, polyphenols, and prebiotic compounds. Boost (three-form vitamin C) addresses the dullness and post-inflammation marks that gut issues commonly leave on skin.",
      timeline: [
