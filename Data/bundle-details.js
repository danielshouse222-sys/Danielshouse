...
window.BUNDLE_DETAILS = {
  ...
  concern: {
    ...
    'dullness': {
      ...
      whyThis: "Dull skin has three causes: surface buildup, pigment irregularities, and oxidative damage. Topical alone addresses the first two. Adding internal nutrient support pushes through the ceiling. Topically: Boost (bio-peptide growth factor serum) brightens pigment irregularities and inhibits melanin transfer; Defense's CE Ferulic architecture neutralizes free-radical damage; Renewal's triple-acid blend accelerates surface turnover to reveal fresh skin. Internally: Radiance covers daily vitamins A/C/E/biotin/zinc — the nutrient foundation skin needs to function and reflect light evenly. Together they produce visible brightness that surface-only protocols can't match.",
      timeline: [
    ...
    'gut': {
      ...
      description: 'Four products — multi-strain probiotic, broad-spectrum digestive enzymes, the 22-ingredient adaptogenic greens, plus the bio-peptide growth factor serum for when the gut-skin axis shows up on your face.',
      whyThis: "Gut health affects nearly every other body system — and the gut-skin axis is one of the strongest connections. This bundle addresses the gut at three complementary levels and supports the skin that bears the visible cost of gut issues. Biome provides multi-strain clinically-studied probiotics with enteric delivery for stomach-acid survival. Seal is a broad-spectrum digestive enzyme complex (amylase, protease, lipase, lactase, cellulase, bromelain, papain) that breaks food down for absorption. Greens provides 22 plant-based ingredients including fiber, polyphenols, and prebiotic compounds. Boost (bio-peptide growth factor serum) addresses the surface inflammation and dullness that gut issues commonly leave on skin.",
      timeline: [
