  ...
  curated: {
    ...
    'daniels-skincare': {
      ...
      faq: [
        ...
        { q: 'How is this different from buying AM + PM separately?', a: "Buying AM + PM as two separate routines totals about 15% off each, applied to two smaller bundle totals — and you'd still be missing the targeted treatments (Awake, Clear) and the weekly resurfacing pair (Mask, Polish). This routine pairs all 16 products at a flat 18% — a deeper discount than either bundle gets on its own — and covers everything the AM and PM rituals leave out." }
      ]
    },
    'am': {
    ...
    'gift-skin-set': {
      ...
      description: "Five essentials for someone ready to take their skincare seriously. Cleanser, CE Ferulic antioxidant, 5-active retinol, hydrating moisturizer, mineral SPF — the daily AM and PM routine, gift-boxed. Sits between The Newcomer Set (4-product first-time skincare) and Daniel's Daily Skincare (the complete 16-product ritual).",
      whyThis: "The Newcomer Set introduces skincare with the daytime essentials — cleanser, antioxidant, moisturizer, SPF. The Skin Set is the next step: adds <strong>Bounce</strong>, the 5-active retinol serum that turns a daytime routine into a complete AM + PM ritual. <strong>Wash</strong> is the rose-hip and Irish-moss daily cleanser — gentle, real cleansing power, no stripping. <strong>Defense</strong> is the CE Ferulic architecture (L-ascorbic acid + ferulic acid + niacinamide + vitamin E) — the most clinically-validated antioxidant serum in dermatology, the same formulation logic SkinCeuticals charges $185 for. <strong>Bounce</strong> stacks five layered actives (retinol + stable vitamin C + hyaluronic acid + Matrixyl peptides + botanical complex) where most competitors charge $74+ for a single-active retinol. <strong>Soft</strong> is the advanced multi-weight hyaluronic acid moisturizer — daily hydration that seals serums in. <strong>Shield</strong> finishes with broad-spectrum non-nano mineral SPF 30 — the most evidence-backed product in skincare and the one step every dermatologist agrees on. Five products, the complete cleanse-treat-protect arc, gift-boxed for someone ready to upgrade from drugstore basics.",
      timeline: [
      ...
      faq: [
        { q: 'How is this different from The Newcomer Set?', a: 'The Newcomer Set (4 products, $163) covers the daytime essentials — Wash, Defense, Soft, Shield. The Skin Set (5 products, $216) adds Bounce, the 5-active retinol serum that anchors the nighttime routine. So Newcomer is "introduction to premium skincare." The Skin Set is "ready for a real AM + PM ritual."' },
        { q: 'How does this compare to Daniel\'s Daily Skincare?', a: 'Daniel\'s Daily Skincare is the complete 16-product line ($559 at 18% off) — every AM step, every PM step, the weekly resurfacing pair (Mask + Polish), the spot treatment (Clear). The Skin Set is the focused 5-product version ($216 at 15% off) — the core ritual without the weekly treatments and spot care. Use The Skin Set as the gift entry to the brand; the recipient can add the rest of the line over time if they want to.' },
