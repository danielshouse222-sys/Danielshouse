  ...
  concern: {
    ...
    'starter': {
      ...
      timeline: [
        ...
        { week: 'Week 12+', text: 'Ready to layer. With a strong barrier you can now add vitamin C (Defense), or treatments like Renewal — without flare-ups.' }
      ],
      faq: [
        ...
        { q: "I'm 25 / 35 / 45 — should I be using more?", a: "Not necessarily, and not at first. Age isn't the variable; barrier health is. Once these three are running and your skin feels resilient, layer Defense (vitamin C + ferulic) in the morning and Bounce (retinol) at night — that's the natural next step." },
        { q: "What order do I use them in?", a: "Morning and night, same order each time: Wash → Balance → Soft. Apply Balance with a cotton pad or fingertips, wait 60 seconds, then Soft on top. The whole routine takes under two minutes." },
