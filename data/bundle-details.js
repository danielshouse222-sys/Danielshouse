...
window.BUNDLE_DETAILS = {
  ...
  concern: {
    ...
    'energy': {
      ...
      whyThis: "Energy starts at the cellular level — specifically, with ATP, the molecule every cell in your body uses for power. This bundle targets that machinery directly. <strong>CoQ10 (Vitality)</strong> is the molecule mitochondria require to produce ATP; it's synthesized endogenously but declines with age and is the single most-studied mitochondrial nutrient. <strong>D3+K2 (Sunshine)</strong> supports the cellular signaling pathways that turn ATP production on; vitamin D deficiency is one of the most common reversible causes of low energy in modern adults. <strong>Omega-3 EPA+DHA (Flow)</strong> feeds the two highest-energy tissues in the body — brain and heart — which together consume roughly a third of total ATP output. <strong>Multi</strong> covers the B-complex, iron, zinc, and trace minerals that serve as cofactors in nearly every ATP-producing enzyme. <strong>Surge</strong> is the optional acute lift on days that need it — caffeine + L-tyrosine for clean stimulation without the L-theanine smoothing-out, which means more usable energy when you actually need it.<br><br>For the comprehensive approach that adds gut-absorption support (Greens + Biome) at the deepest discount, see The Full Energy Stack.",
      timeline: [
      ...
      faq: [
        ...
        { q: 'How is this different from The Full Energy Stack?', a: 'Same cellular fuel core (Multi, Vitality, Sunshine, Flow, Surge) — the Full Energy Stack adds Greens and Biome for the gut-absorption side and ships at 18% off instead of 12%. Use The Energy Bundle if you want focused mitochondrial support; use Full Energy if you want comprehensive coverage with the deeper discount.' },
    ...
    'full-energy': {
      eyebrow: 'Inside-Out Energy · The Comprehensive Stack',
      description: 'Seven supplements covering both cellular ATP production (Multi + Vitality + Sunshine + Flow + Surge — the Energy Bundle) and gut-driven nutrient absorption (Greens + Biome). The comprehensive approach for customers who want full inside-out energy coverage in a single purchase.',
      whyThis: "Energy isn't one mechanism — it's two stacked mechanisms working together. The body absorbs nutrients (gut) and then produces ATP from them (cellular machinery). Most energy supplements address one half. This bundle addresses both. <strong>Cellular ATP side</strong>: CoQ10 directly supplies the molecule mitochondria use to produce ATP; D3+K2 supports the cellular signaling that powers it; omega-3 EPA+DHA feeds brain and cardiovascular tissue specifically; Multi covers the B-complex and trace mineral cofactors for ATP-producing enzymes; Surge handles the optional clean morning lift. <strong>Gut absorption side</strong>: Greens delivers 22 micronutrients most diets miss; Biome supports the gut microbiome that determines how much of any nutrition actually reaches your cells. Together: nutrient absorption and cellular fuel production both addressed. The 18% bundle discount is the deepest discount available outside the Ultimate Routine.",
      timeline: [
      ...
      faq: [
        { q: 'How is this different from The Energy Bundle?', a: 'The Energy Bundle is the 5-product cellular fuel stack (Multi + Vitality + Sunshine + Flow + Surge) at 12% off. The Full Energy Stack adds Greens and Biome — the two products that handle gut absorption — and ships at 18% off instead of 12%. Use The Energy Bundle if you want focused mitochondrial support; use Full Energy if you want comprehensive inside-out coverage with the deeper discount.' },
