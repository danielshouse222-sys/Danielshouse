...
window.BUNDLE_DETAILS = {
  curated: {
    ...
    'daniels-skincare': {
      ...
      description: "Every product in the skincare line — AM ritual through PM ritual through the targeted treatments through the weekly reset. Twenty-one formulations, the same deep discount Daniel's Daily Supplements get, the complete topical half of the Ultimate Routine plus the new targeted treatments. For customers who already have their supplement game figured out and want the full skincare house.",
      whyThis: "The skincare half of the Ultimate, without the supplements — and broader than the Ultimate's skincare half because it includes the targeted layer. The 7 AM steps (Wash, Balance, Boost, Plump, Defense, Soft, Shield) prep, protect, and shield the skin every morning — botanical cleanser, 3.5% glycolic exfoliator, bio-peptide growth factor serum, pure HA, CE Ferulic antioxidant architecture, advanced HA moisturizer, and broad-spectrum mineral SPF. The 6 PM steps (Bounce, Renewal, Firm, Mist, Awake, Glow) work at night when active ingredients aren't fighting UV — five-active retinol, multi-action peeling pads, advanced peptide complex, hyaluronic mist, DCX peptide eye serum, and squalane + HA spheres. Six targeted treatments handle the work the daily rituals leave out: Bright (multi-pathway brightening for hyperpigmentation), Lift (neck-and-décolleté firming), Lipid (clinical-grade barrier-repair lipid blend), Clear (daily 2% salicylic clarifier), Spot (overnight apothecary drying lotion), and Awake (under-eye complex). Mask, Polish, and the new overnight collagen mask Dream form the weekly reset that compounds everything else. Together it's the full topical protocol, layered for compounding effect.",
      timeline: [
        { week: 'Week 1', text: 'Texture feels cleaner and more balanced. Less midday shine; product layering becomes second nature.' },
        { week: 'Week 4', text: 'Mist holds through the day; pore appearance refines. The retinol + peptide nightly routine starts showing visible smoothing. Bright begins to fade early dark spots.' },
        { week: 'Week 8', text: 'Tone evens out; fine lines soften measurably. Weekly mask + polish + Dream ritual produces visible "post-treatment" glow. Lift starts showing neck-firming results.' },
        { week: 'Week 12+', text: 'Durable skin baseline. Brighter tone, firmer texture, fewer breakouts, the compound effect of twenty-one actives working together properly sequenced.' }
      ],
      faq: [
        { q: 'Do I really use all 21 products?', a: "Not every product every day. AM and PM rituals run daily (13 products). Bright is daily for those targeting hyperpigmentation. Lift is daily (AM and PM on the neck). Clear and Spot are as-needed for breakouts. Lipid is occasional, for barrier-stressed nights. Mask, Polish, and Dream are weekly. Most days you'll use 11–15 of the 21, with the targeted layer used as your skin asks for it." },
        { q: 'What order do I apply them in?', a: 'AM: Wash → Balance (glycolic) → Bright (brightening, optional) → Boost (peptide growth factor) → Plump → Defense (CE Ferulic) → Soft → Lift (neck) → Shield (mineral SPF). PM: Wash → Renewal (multi-acid pads) OR Bounce (5-active retinol) — alternate nights → Bright (PM optional) → Firm → Mist (HA mist) → Awake → Lift (neck) → Glow (HA-in-squalane seal). Spot is dabbed on individual blemishes at any point. Lipid replaces Glow on barrier-stressed nights. Dream is layered over moisturizer 2-3 nights/week. Mask + Polish are weekly add-ons.' },
        { q: 'Can I subscribe to all 21?', a: 'Yes — and Smart Refill is the right cadence here. The skincare line has products on 1, 2, 3, and 6-month cycles. Smart Refill ships each bottle only when its cadence comes due, so you don\'t end up stockpiling unused bottles of Renewal while you blow through Wash. Same discount, smarter shipments.' },
        { q: 'How is this different from buying AM + PM separately?', a: "Buying AM + PM as two separate routines totals about 15% off each, applied to two smaller bundle totals — and you'd still be missing the entire targeted treatments layer (Bright, Lift, Lipid, Clear, Spot, Awake), the weekly resurfacing pair (Mask + Polish), and the new overnight collagen mask (Dream). This routine pairs all 21 products at a flat 18% — a deeper discount than either bundle gets on its own — and covers everything the AM and PM rituals leave out." }
      ]
    },
    'am': {
    ...
    'gift-skin-set': {
      ...
      faq: [
        ...
        { q: 'How does this compare to Daniel\'s Daily Skincare?', a: 'Daniel\'s Daily Skincare is the complete 21-product line ($746 at 18% off) — every AM step, every PM step, the targeted treatments (Bright, Lift, Lipid, Clear, Spot, Awake), the weekly resurfacing pair (Mask + Polish), the new overnight collagen mask (Dream). The Skin Set is the focused 5-product version ($216 at 15% off) — the core ritual without the targeted treatments and weekly add-ons. Use The Skin Set as the gift entry to the brand; the recipient can add the rest of the line over time if they want to.' },
