...
window.BUNDLE_DETAILS = {
  curated: {
    ...
    'daniels-skincare': {
      ...
      whyThis: "The skincare half of the Ultimate, without the supplements. The 7 AM steps (Wash, Balance, Boost, Plump, Defense, Soft, Shield) prep, protect, and shield the skin every morning — botanical cleanser, 3.5% glycolic exfoliator, bio-peptide growth factor serum, pure HA, CE Ferulic antioxidant architecture, advanced HA moisturizer, and broad-spectrum mineral SPF. The 6 PM steps (Bounce, Renewal, Firm, Mist, Awake, Glow) work at night when active ingredients aren't fighting UV — five-active retinol, multi-action peeling pads, advanced peptide complex, hyaluronic mist, DCX peptide eye serum, and squalane + HA spheres. Clear handles daily clarification (BHA at 2%), Mask and Polish are the weekly reset that compounds everything else. Together it's the full topical protocol, layered for compounding effect.",
      timeline: [
      ...
      faq: [
        ...
        { q: 'How is this different from buying AM + PM + Reset separately?', a: "Buying AM + PM + Reset as three separate routines totals about 14% off (15% on each, applied to smaller bundle totals). This routine pairs all 16 at a flat 18% — the same discount Daniel's Daily supplement stack gets — plus the targeted treatments (Awake, Clear) that don't fit cleanly into either AM or PM." }
      ]
    },
    'am': {
    ...
    'workout': {
      ...
      faq: [
        { q: 'When should I take each?', a: 'Surge + Pump: 30-45 min pre-workout. Power: post-workout with carbs (or any consistent daily time). Seal: post-workout or pre-bed. Greens: morning or any time of day.' },
    ...
    'full-energy': {
      eyebrow: 'Inside-Out Energy · Both Halves at the Deepest Discount',
      description: 'Seven supplements covering both cellular ATP production (Multi + Vitality + Sunshine + Flow + Surge — the Energy Bundle) and gut-driven nutrient absorption (Greens + Biome — the Clean Energy Bundle). The comprehensive approach for customers who want full inside-out energy coverage in a single purchase.',
      whyThis: "Energy isn't one mechanism — it's two stacked mechanisms working together. The body absorbs nutrients (gut) and then produces ATP from them (cellular machinery). Most energy supplements address one half. This routine addresses both. <strong>Cellular ATP side</strong> (from The Energy Bundle): CoQ10 directly supplies the molecule mitochondria use to produce ATP; D3+K2 supports the cellular signaling that powers it; omega-3 EPA+DHA feeds brain and cardiovascular tissue specifically; Multi covers the B-complex and trace mineral cofactors for ATP-producing enzymes; Surge handles the optional clean morning lift. <strong>Gut absorption side</strong> (from The Clean Energy Bundle): Greens delivers 22 micronutrients most diets miss; Biome supports the gut microbiome that determines how much of any nutrition actually reaches your cells. Together: nutrient absorption and cellular fuel production both addressed. The 18% routine discount makes the comprehensive approach genuinely cost-effective vs buying both bundles separately at 12% off each.",
      timeline: [
      ...
      faq: [
        { q: 'Why buy this instead of the two bundles separately?', a: 'Economics. The Energy Bundle is 12% off; The Clean Energy Bundle is 12% off. The Full Energy Stack routine is 18% off the same products. For comprehensive customers, this is the deepest discount available outside the Ultimate Routine, and the seven products work as a coordinated system.' },
        ...
        { q: 'What if I only need one half?', a: 'Buy the appropriate single bundle instead. Energy Bundle ($144) for cellular ATP work; Clean Energy Bundle ($98) for gut absorption work. The Full Energy Stack only makes sense if both halves apply.' },
    ...
    'gift-skin-set': {
      ...
      description: "Thirteen products — the complete AM and PM skincare ritual, gift-ready. For the friend who takes their skin seriously, or wants to. Cleanser through SPF in the morning, retinol through overnight oil at night.",
      whyThis: "The biggest skincare gesture short of the Ultimate. The full ritual — every step the line offers across AM and PM, in one gift box. AM is the same seven-step morning routine Daniel runs: Wash, Balance (3.5% glycolic), Boost (bio-peptide growth factor), Plump (HA serum), Defense (CE Ferulic), Soft (HA moisturizer), Shield (mineral SPF). PM is the six-step evening complement: Bounce (5-active retinol), Renewal (multi-action peeling pads — glycolic + lactic + salicylic), Firm (advanced peptide complex), Mist (HA gel-cream), Awake (triple-peptide eye), Glow (squalane + HA oil). The two routines compound — what the morning protects, the evening repairs and resurfaces. Thirteen products at clinical doses, the same formulas used by people who pay $400+ for the equivalents at Sephora.",
      timeline: [
        { week: 'Week 1', text: 'Initial acclimation to retinol and the resurfacing pads. Skin feels deeply hydrated from the AM serum stack and PM Mist + Glow.' },
        { week: 'Week 4', text: 'Visible brightness; texture noticeably smoother from Renewal\'s tri-acid effect compounding with retinol. Bounce starts showing on fine lines around the eyes.' },
      ...
      faq: [
        ...
        { q: 'Order to use, AM and PM?', a: 'AM: Wash → Balance → Boost → Plump → Defense → Soft → Shield. PM: Wash (reuse) → Bounce OR Renewal OR Firm (alternate — never two strong actives the same night) → Mist → Awake → Glow.' },
        { q: 'How does this compare to the Daniel\'s Daily Skincare routine?', a: 'Same daily AM + PM ritual, gift-packaged. Daniel\'s Daily adds the weekly reset products (Clear spot treatment, Mask, Polish) for sixteen products total at a deeper 18% discount. The Skin Set focuses on the everyday AM + PM ritual — for someone new to the line, this is the cleaner introduction.' },
  ...
  concern: {
    ...
    'acne': {
      ...
      description: 'A five-product clear-skin protocol — colloidal sulfur spot treatment, zinc & sulfur weekly mask, and morning vitamin C for the surface, plus probiotics and omega-3s for the gut-skin connection behind chronic breakouts.',
      whyThis: "Chronic acne is rarely just a surface problem. The gut-skin axis is well-documented: gut inflammation, dysbiosis, and systemic inflammation reliably worsen acne. This protocol works both sides. Clear (colloidal sulfur + salicylic acid + zinc oxide) dries up active spots overnight. Mask (bentonite + sulfur + salicylic acid + zinc oxide, weekly) draws out accumulated impurities and tightens pore appearance. Boost (bio-peptide growth factor serum) brightens the post-blemish marks acne leaves behind. Internally, Biome's multi-strain probiotic helps restore the gut microbiome that correlates with cleaner skin in clinical trials; Flow's omega-3 EPA/DHA actively resolves inflammation. Together they address acne at its actual root causes.",
      timeline: [
    ...
    'dryness': {
      ...
      description: 'Four hydration-focused products — multi-weight hyaluronic acid serum, refreshing HA mist for body and face, multi-action daily moisturizer with niacinamide and HA, plus omega-3s that build the lipid matrix that holds water in skin.',
      whyThis: "Lasting hydration requires three things: humectants (HA), emollients (cream + barrier-supportive lipids), and the structural support that keeps moisture from escaping. Topically: Plump delivers a clean, multi-weight HA serum at multiple depths; Mist is a featherweight hyaluronic face and body mist (HA + rose centifolia water + glycerin + sodium lactate) that layers cleanly over moisturizer for instant refreshment; Soft is the advanced daily HA moisturizing cream that delivers all-day hydration with niacinamide and barrier-supportive emollients. Internally: Flow's omega-3 EPA/DHA are precursors to skin ceramides — your barrier literally builds from dietary fatty acids. Topical alone is corrective; pairing with internal nutrient support is preventive and durable. (For lipid-seal occlusion on top, add Glow — hyaluronic spheres in squalane — as an overnight final step.)",
      timeline: [
    ...
    'dullness': {
      ...
      description: 'Three brightening products — the CE Ferulic-tier antioxidant serum, multi-action peeling pads, and the daily beauty vitamin foundation. The inside-out approach to measurable luminosity.',
      whyThis: "Dull skin has three causes: surface buildup, pigment irregularities, and oxidative damage. Topical alone addresses the first two. Adding internal nutrient support pushes through the ceiling. Topically: Defense's CE Ferulic architecture (L-ascorbic acid + ferulic acid + niacinamide + B5 + vitamin E) neutralizes free-radical damage and inhibits melanin transfer; Renewal's multi-action peeling pads (glycolic + lactic + salicylic) accelerate surface turnover to reveal fresh skin underneath. Internally: Radiance covers daily vitamins A/C/E/biotin/zinc — the nutrient foundation skin needs to function and reflect light evenly. Together they produce visible brightness that surface-only protocols can't match.",
      timeline: [
    ...
    'sensitivity': {
      ...
      whyThis: "Reactive skin often has a systemic-inflammation component that surface-only protocols miss. Topically: Wash is fragrance-free and barrier-respecting (rose hip seed oil, geranium, Irish moss); Plump is a minimalist water-and-HA serum that delivers pure barrier-supporting hydration without potentially-irritating extras; Soft is an advanced daily HA moisturizing cream that delivers multi-weight hydration with niacinamide and barrier-supportive emollients. Internally: Biome's probiotic addresses the gut-skin axis — reactive skin often correlates with gut dysbiosis; Flow's omega-3 EPA/DHA actively resolves inflammation systemically. Together they heal the barrier from both sides instead of perpetuating the reactive cycle.",
      timeline: [
    ...
    'sleep': {
      ...
      description: 'Four products — magnesium glycinate and clinical-grade ashwagandha for the nervous system, plus the overnight HA moisturizing cream and eye treatment that put your routine to bed.',
      whyThis: "Sleep quality affects skin repair directly — your skin does its biggest repair work between 10 PM and 2 AM. This bundle pairs sleep-improving supplements with the overnight skincare that takes advantage of that repair window. Calm (magnesium glycinate) supports the GABA pathway and nervous system relaxation. Tranquil (clinical-grade ashwagandha) reduces serum cortisol over 4-6 weeks, improving sleep architecture. Soft (overnight HA moisturizing cream) seals in moisture during the repair window. Awake addresses the puffiness and dark circles that show when sleep is short. Together: a wind-down ritual that visibly shows by morning.",
      timeline: [
    ...
    'energy': {
      eyebrow: 'Cellular ATP · The Mitochondrial Fuel Stack',
      description: 'Five supplements that target cellular ATP production: CoQ10 for mitochondrial energy, D3+K2 for the signaling that powers it, omega-3 EPA+DHA for brain and cardiovascular tissue, Multi for the micronutrient baseline, and Surge for the optional clean morning lift.',
      whyThis: "Energy starts at the cellular level — specifically, with ATP, the molecule every cell in your body uses for power. This bundle targets that machinery directly. <strong>CoQ10 (Vitality)</strong> is the molecule mitochondria require to produce ATP; it's synthesized endogenously but declines with age and is the single most-studied mitochondrial nutrient. <strong>D3+K2 (Sunshine)</strong> supports the cellular signaling pathways that turn ATP production on; vitamin D deficiency is one of the most common reversible causes of low energy in modern adults. <strong>Omega-3 EPA+DHA (Flow)</strong> feeds the two highest-energy tissues in the body — brain and heart — which together consume roughly a third of total ATP output. <strong>Multi</strong> covers the B-complex, iron, zinc, and trace minerals that serve as cofactors in nearly every ATP-producing enzyme. <strong>Surge</strong> is the optional acute lift on days that need it — caffeine + L-tyrosine for clean stimulation without the L-theanine smoothing-out, which means more usable energy when you actually need it.<br><br><strong>The difference vs. The Clean Energy Bundle:</strong> this stack acts on the cellular machinery that produces energy. Clean Energy acts on the gut-absorption side that determines how much fuel reaches that machinery. They overlap on Surge (clean stimulation) and Multi (micronutrient baseline), but target opposite halves of the energy equation. Use this bundle if you feel fatigued despite eating reasonably well; use Clean Energy if you suspect what you eat isn't actually reaching your cells.",
      timeline: [
        { week: 'Week 1', text: 'Surge delivers same-day acute lift. Omega-3 begins to load into cell membranes (steady-state takes 4-6 weeks).' },
        { week: 'Week 4', text: 'Multi nutrient stores fill in. D3 levels begin to rise noticeably (full repletion takes 8-12 weeks if starting deficient). Daily energy stabilizes; afternoon crashes less pronounced.' },
        { week: 'Week 8', text: 'CoQ10 effect on mitochondrial energy markedly improved — particularly in adults 40+ where endogenous CoQ10 synthesis has declined.' },
        { week: 'Week 12+', text: 'Cellular ATP machinery operating at higher baseline. Less reliance on caffeine; more steady output across the day. The compound effect that mitochondrial supplementation builds toward.' }
      ],
      faq: [
        { q: 'When should I take each supplement?', a: 'Morning with breakfast: Multi, Vitality, Sunshine, and Flow (the fat-soluble vitamins and omega-3 all absorb best with food, ideally something containing healthy fats). Surge: 30 minutes before deep work or training, or as a clean coffee replacement. Avoid Surge after 2 PM if you\'re sleep-sensitive.' },
        { q: 'Is Surge a stimulant? Will it stack with coffee?', a: "Surge contains caffeine plus L-carnitine, green tea, and B-vitamins — moderate stimulation with the metabolic and mood layer added. Yes, it stacks with coffee, but most users do well taking Surge instead of (not on top of) a second cup. Don't take after 2 PM if you're sleep-sensitive." },
        { q: 'How is this different from The Clean Energy Bundle?', a: 'Energy targets cellular ATP production — CoQ10 for mitochondrial fuel, D3+K2 for cellular signaling, omega-3 for brain/heart tissue. Clean Energy targets nutrient absorption — Greens for micronutrient density, Biome for the gut microbiome that determines how much of what you eat actually reaches your cells. Both share Multi (baseline) and Surge (optional lift), but otherwise act on different stages of the same process. <strong>Quick rule:</strong> if you feel run-down at the cellular level (especially common in adults 35+), choose Energy. If you eat well but feel sluggish anyway, choose Clean Energy. If both apply, stack them.' },
        { q: 'When will I notice changes?', a: 'Same-day from Surge. Daily energy stabilization at 4-6 weeks as Multi nutrient stores fill in. CoQ10\'s mitochondrial effect builds noticeably at 8-12 weeks (particularly meaningful in adults 40+). D3 effect depends on starting deficiency status — strongest in winter months and northern climates.' }
      ]
    },
    'focus': {
    ...
    'mushroom-trio': {
      ...
      whyThis: "Functional mushroom research, when you read it carefully, almost never tests broad-spectrum 10-mushroom blends. It tests single mushrooms at single doses. Lion\'s Mane in the Mori 2009 cognitive RCT: 3,000 mg/day. Reishi in the Jin 2016 Cochrane review for stress and fatigue: 1,500-5,400 mg/day. Cordyceps militaris in the Hirsch 2017 exercise tolerance RCT: 4,000 mg/day. The strongest evidence base sits with single mushrooms at clinical doses — not broad-spectrum blends at sub-clinical doses each. The Mushroom Trio gives you the three with the strongest published evidence (cognition, stress, energy) at the entry clinical dose for each. <strong>How this differs from Synapse:</strong> Synapse is the broad-spectrum daily gummy at sub-clinical individual doses — the easy daily wellness option. The Mushroom Trio is the targeted clinical-dose approach. Both are legitimate; they serve different jobs. Many customers use both — Synapse for daily broad coverage, the Trio when they want clinical-grade support across the cognition/stress/energy axes.",
      timeline: [
      ...
      faq: [
        { q: 'How is this different from Synapse?', a: 'Synapse is broad-spectrum: 10 mushrooms in one gummy at sub-clinical individual doses. Easy compliance, daily wellness layer, $34. The Mushroom Trio is targeted: 3 mushrooms each at clinical doses, capsule format, $73 at the 15% bundle discount. Different jobs. If you want a broad mushroom layer in your daily routine, Synapse. If you want clinical-dose Lion\'s Mane, Reishi, and Cordyceps specifically, the Trio.' },
    ...
    'metabolic': {
      eyebrow: 'Gut-Driven Absorption · The Food-to-Fuel Stack',
      description: 'Four supplements that target the gut-absorption side of energy: Greens for the 22-ingredient nutrient density most diets miss, Biome for the microbiome that determines how much of any of it reaches your cells, Multi for the daily baseline, Surge for the optional clean morning lift.',
      whyThis: "Most people eat enough nutrients; far fewer actually absorb them. This bundle works the absorption side of energy — what happens between the food on your plate and the cells that turn it into ATP. <strong>Greens</strong> layers in 22 plant-based ingredients (fiber, polyphenols, prebiotics, adaptogens) covering the micronutrient density most diets fall short on; the raw material your gut has to absorb. <strong>Biome</strong> supports the gut microbiome that determines how much of any of it actually crosses into circulation — modern research links gut microbiota composition to nutrient absorption, short-chain fatty acid production, inflammation regulation, and the gut-energy axis. <strong>Multi</strong> covers the vitamin and mineral baseline that gives the other two something to work on. <strong>Surge</strong> is the optional acute lift on days that need it — caffeine + L-tyrosine + L-carnitine, with the L-carnitine specifically shuttling fatty acids into mitochondria for fuel (the only nod to the cellular side in this bundle).<br><br><strong>The difference vs. The Energy Bundle:</strong> this stack acts on the absorption side — getting nutrients from food into circulation and across the gut barrier. Energy acts on the cellular machinery that produces ATP once nutrients arrive. They overlap on Surge and Multi, but target opposite halves of the energy equation. Use Clean Energy if you eat reasonably but feel sluggish anyway (typical sign of absorption issues); use Energy if you feel fatigued at the cellular level despite adequate nutrition. Both stacked together is the full inside-out approach.",
      timeline: [
        { week: 'Week 1', text: 'Acute lift from Surge from day one. Biome begins to colonize and digestion starts to normalize.' },
        { week: 'Week 4', text: 'Nutrient gaps in Greens and Multi fill in. Cravings settle as gut microbiome stabilizes. Bloating, irregular digestion improving.' },
        { week: 'Week 8', text: 'Gut microbiome shift compounds — better nutrient absorption noticeable through more consistent energy between meals, less afternoon crash.' },
        { week: 'Week 12+', text: 'Sustained absorption baseline. The gut-energy axis stabilizes — food becomes fuel more efficiently rather than ballast.' }
      ],
      faq: [
        { q: 'Is this a weight-loss bundle?', a: 'No — this is a gut-and-absorption health bundle. The components support how your body extracts energy from food, not how much of that food you eat. Better gut absorption and micronutrient sufficiency are foundations weight goals can work on, but nothing in this stack is appetite-suppressing or fat-burning by design.' },
        { q: 'How is this different from The Energy Bundle?', a: 'Two halves of the same problem. Energy targets cellular ATP production: CoQ10 for mitochondrial fuel, D3+K2 for cellular signaling, omega-3 EPA+DHA for brain and heart tissue specifically. Clean Energy targets gut absorption: Greens for micronutrient density, Biome for the microbiome that determines how much of any of it actually reaches your bloodstream. Both share Multi (the baseline) and Surge (the optional clean lift), but otherwise act on different stages of the same energy pathway. <strong>Quick rule:</strong> if your diet is decent but you still feel sluggish, choose Clean Energy (absorption issue). If you feel cellularly run-down — especially common in adults 35+ where mitochondrial function declines — choose Energy. If both apply, stack them and run for 8-12 weeks before evaluating.' },
        { q: 'Is Surge safe daily?', a: 'Yes at recommended dose. Surge contains caffeine — about a small cup of coffee per serving — plus L-carnitine, green tea, and B-vitamins. Stack it with coffee with caution; sensitive sleepers should take it before 2 PM.' },
        { q: 'When should I take each?', a: 'Surge: morning or 30 minutes before deep work / training. Greens: with breakfast or as a smoothie base. Biome: empty stomach in the morning works best for most. Multi: with food (fat-soluble vitamins absorb better that way).' }
      ]
    }
  }
};
